...
//  @Test (Test failed)
//  void shouldNotTransferMoneyFromAndToTheSameCard() {
//    var loginPage = open("http://localhost:9999", LoginPage.class);
//    var authInfo = DataHelper.getAuthInfo();
//    var verificationPage = loginPage.validLogin(authInfo);
//    var verificationCode = DataHelper.getVerificationCode();
...
//    transferPage.findErrorMessage("Перевод c карты на эту же карту невозможен");
//    var actualBalanceFirstCard = dashboardPage.getCardBalance(firstCardInfo);
//    var actualBalanceSecondCard = dashboardPage.getCardBalance(secondCardInfo);
//    assertEquals(expectedBalanceFirstCard, actualBalanceFirstCard);
//    assertEquals(expectedBalanceSecondCard, actualBalanceSecondCard);
...
//  @Test (Test failed)
//  void shouldGetErrorMessageIfFirstCardAmountMoreThanBalance() {
//    var loginPage = open("http://localhost:9999", LoginPage.class);
//    var authInfo = DataHelper.getAuthInfo();
//    var verificationPage = loginPage.validLogin(authInfo);
//    var verificationCode = DataHelper.getVerificationCode();
...
//
//  @Test (Test failed)
//  void shouldGetErrorMessageIfSecondCardAmountMoreThanBalance() {
//    var loginPage = open("http://localhost:9999", LoginPage.class);
//    var authInfo = DataHelper.getAuthInfo();
//    var verificationPage = loginPage.validLogin(authInfo);
//    var verificationCode = DataHelper.getVerificationCode();
